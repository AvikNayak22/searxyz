    ...
    return (
        <div className="p-[15px] pb-0 md:pr-5 md:pl-20 md:pt-7 border-b border-[#ebebeb] flex md:block flex-col items-center sticky top-0 bg-white">
            <div className="flex items-center justify-between w-full">
                ...
                <div className="hidden md:block"><GiHamburgerMenu className="text-[20px] line-height hover:text-[#644FED] cursor-pointer" /></div>
            </div>
                ...
                {menu.map((menu, index) => (
                    <span
                        ...
                        className={`flex items-center p-3 text-[#5f6368] cursor-pointer relative ${
                            selectedMenu === menu.name ? "text-[#5037EB]" : ""
                        }`}
                    ...
                    >
                        ...
                        {selectedMenu === menu.name && (
                            <span className="h-[3px] w-[calc(100%-20px)] absolute bg-[#5037EB] bottom-0 left-[10px]" />
                        )}
                    </span>
                ))}
            </div>
